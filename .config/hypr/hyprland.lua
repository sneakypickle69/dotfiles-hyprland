...
-- Refer to truehttps://wiki.hypr.land/Configuring/Basics/Variables/
local color_path = os.getenv("HOME") .. "/.cache/wal/colors-hyprland.lua"
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { colors.color14, colors.color1 }, angle = 135 },
